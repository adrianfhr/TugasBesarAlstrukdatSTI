...
void HELP(){
    ...
    printf("3. SAVE <txt>           <Menyimpan state game pemain saat ini ke dalam file> \n");
    ...
    printf("9. SKIPGAME <n>         <Melewatkan permainan> \n");
    ...
    printf("12. HISTORY <n>         <Menampilkan history permainan yang telah dimainkan> \n");
